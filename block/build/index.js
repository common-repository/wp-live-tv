...
// Module
___CSS_LOADER_EXPORT___.push([module.i, "div[data-type='wptv/tv-player'] button {\n  margin: 28px 0 0 10px; }\n", "",{"version":3,"sources":["webpack://./src/style.scss"],"names":[],"mappings":"AAAA;EACE,qBAAqB,EAAA","sourcesContent":["div[data-type='wptv/tv-player'] button {\r\n  margin: 28px 0 0 10px;\r\n}"],"sourceRoot":""}]);
// Exports
...
var Edit = /*#__PURE__*/function (_Component) {
  ...
  function Edit() {
    ...
    _defineProperty(_assertThisInitialized(_this), "state", {
      ...
      edit: '' === _this.props.attributes.id
    });
  ...
  _createClass(Edit, [{
    ...
    key: "getStationView",
    value: function () {
      var _getStationView = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee() {
        var attributes, station_view;
      ...
      function getStationView() {
        return _getStationView.apply(this, arguments);
      }

      return getStationView;
    }()
  }, {
    ...
    value: function render() {
      ...
      var _this$state = this.state,
          ...
          loadingStationView = _this$state.loadingStationView,
      ...
      }, "Done"))), wp.element.createElement(BlockControls, null, wp.element.createElement(Button, {
      ...
      }, "Change Station")), edit || !attributes.id ? wp.element.createElement(Placeholder, {
        icon: "controls-play",
      ...
      }, "Enter the ID of the TV channel in the ", wp.element.createElement("strong", null, "Channel ID"), " input field."), wp.element.createElement(TextControl, {
        label: __('Channel ID', 'wp-radio'),
        value: attributes.id,
        onChange: function onChange(newValue) {
          _this2.setState({
      ...
      }, "Done")) : wp.element.createElement(Fragment, null, loadingStationView ? wp.element.createElement(Placeholder, {
        icon: "controls-play",
        label: __('TV Player', 'wp-radio')
